# Credits to Sysys242 for this captcha solver :)
# ---> https://github.com/Sysys242/
...
class Solver():
    ...
    def solveCaptcha2(self) -> str:
        r = requests.post(f"https://api.capsolver.com/createTask",json=payload2("capsolver.com",self.proxy,"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36"))
        try:
            if r.json().get("taskId"):
                taskid = r.json()["taskId"]
            else:
